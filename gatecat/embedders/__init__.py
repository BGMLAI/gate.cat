"""Pluggable embedder registry for gatecat.
...
Usage:
    from gatecat.embedders import get_embedder, register_embedder, BaseEmbedder
...
class BaseEmbedder(abc.ABC):
    """Abstract base class for all gatecat embedders.
...
def register_embedder(name: str, cls: type[BaseEmbedder]) -> None:
    ...
    _registry[name] = cls
    logger.debug("[gatecat] Registered embedder: %s", name)
