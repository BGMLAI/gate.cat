...
class Gate:
    ...
    Args:
        ...
        embedder: opcjonalny embedder (np. gatecat get_embedder("minilm")) do
    ...
    # --- pomocnicze do auto-embeddera z gatecat ---
    def with_minilm(self) -> "Gate":
        """Włącz semantyczny rozrzut przez gatecat MiniLM (ONNX, CPU, ~90MB).
