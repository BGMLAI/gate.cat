...
Usage:
    ...
    cacheback audit data.jsonl   # "ile zgaduje TWOJ agent" — gate-audit na endpoincie
"""
...
def cmd_audit(args):
    ...
    """
    from cacheback.audit import run_audit
    ...
    try:
        ...
        print("Brak httpx. Zainstaluj: pip install 'cacheback-ai[proxy]'")
        return
    ...
    if report.confident_wrong > 0:
        ...
        print(">>   pip install cacheback-ai   |   https://bgmlai.github.io/gate-landing/")
