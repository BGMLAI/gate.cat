...
| F3 | Test suite | 892 passed / 28 skipped / 0 failed, on py3.11+3.12+3.13 | CI run [28934191829](https://github.com/BGMLAI/gate.cat/actions/runs/28934191829) (`.github/workflows/ci.yml`) | tag v0.4.1 = `eb8cc08` (2026-07-08) | "892 tests green in CI as of v0.4.1 (ubuntu, py3.11–3.13)" | unversioned "900+ tests"; the pre-CI local count 907 (superseded — skips differ per env, CI number is the checkable one) |
...
| F9 | Installable version | 0.4.1 | https://pypi.org/project/gate.cat/ · tag `v0.4.1` = `eb8cc08`; hero snippet clean-venv-verified against the PyPI wheel | 2026-07-08 | "0.4.1 on PyPI; tag v0.4.1 is the installable version" | citing GitHub-only versions as installable |
