...
| F9 | Installable version |  0.4.6 | https://pypi.org/project/gate.cat/ · tag `v0.4.6` = `5430a40`; hero snippet clean-venv-verified against the PyPI wheel; Beta + Topic::Security classifiers live | 2026-07-08 | "0.4.6 on PyPI; tag v0.4.6 is the installable version" | citing GitHub-only versions as installable |
