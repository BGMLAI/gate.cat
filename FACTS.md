...
| F9 | Installable version | 0.4.16 | [PyPI 0.4.16](https://pypi.org/project/gate.cat/0.4.16/) and [GitHub release v0.4.16](https://github.com/BGMLAI/gate.cat/releases/tag/v0.4.16); clean no-cache install from the public PyPI index verified distribution/runtime 0.4.16, 71 defaults and 73 presets | 2026-07-13 | "0.4.16 is installable from PyPI and pinned by GitHub release v0.4.16" | citing an unpublished branch or local wheel as the installable release |
