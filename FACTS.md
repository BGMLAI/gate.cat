...
| F9 | Installable version |   0.4.8 | https://pypi.org/project/gate.cat/ · tag `v0.4.8` = `854a3b4`; clean-venv-verified against the PyPI wheel (`__version__` 0.4.8, 28 defaults, extra-policies loader importable + fail-closed, hook blocks `restic forget --prune` from the installed package); Beta + Topic::Security classifiers live | 2026-07-09 | "0.4.8 on PyPI; tag v0.4.8 is the installable version" | citing GitHub-only versions as installable |
