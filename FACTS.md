...
| F9 | Installable version | 0.4.4 | https://pypi.org/project/gate.cat/ · tag `v0.4.4` = `f6e3091`; hero snippet clean-venv-verified against the PyPI wheel; Beta + Topic::Security classifiers live | 2026-07-08 | "0.4.4 on PyPI; tag v0.4.4 is the installable version" | citing GitHub-only versions as installable |
