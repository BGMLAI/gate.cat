...
| F9 | Installable version | 0.4.3 | https://pypi.org/project/gate.cat/ · tag `v0.4.3` = `8469248`; hero snippet + recall harness (43/43, 0/13) clean-venv-verified against the PyPI wheel | 2026-07-08 | "0.4.3 on PyPI; tag v0.4.3 is the installable version" | citing GitHub-only versions as installable |
