...
| F9 | Installable version | 0.4.5 | https://pypi.org/project/gate.cat/ · tag `v0.4.5` = `ee80318`; hero snippet clean-venv-verified against the PyPI wheel; Beta + Topic::Security classifiers live | 2026-07-08 | "0.4.5 on PyPI; tag v0.4.5 is the installable version" | citing GitHub-only versions as installable |
